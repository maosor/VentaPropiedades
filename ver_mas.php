          ...
          <div class="row">
            ...
            <div class="col s4">
              ...
              if ($f_ase =$res_ase->fetch_assoc()) {
               ...
               ?>
               <img src="admin/usuario/<?php echo $f_ase['foto'] ?>" width="100" class="circle">
            </div>
            <div class="col s8">
         ...
         <div class="card-content">
           <div class="row">
             ...
             while ($f_img =$res_img->fetch_assoc()) {?>
               <div class="col s3">
                 <img src="admin/propiedades/<?php echo $f_img['ruta'] ?>" width="200" class="materialboxed" >
               </div>
              <?php }
              ?>
            </div>
     ...
     <div class="col s12">
       <div class="card">
         <div class="card-content">
           ...
           <div class="row">
             <div class="col s6">
               <iframe src="admin/propiedades/mapa.php?mapa=<?php echo $f['mapa']?>" width="100%" height="500"
